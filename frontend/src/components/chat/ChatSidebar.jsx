    ...
    <>
      ...
      <motion.aside
        ...
        className="
          ...
          w-[255px] shrink-0 flex flex-col
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-3 py-2 space-y-1 scrollbar-none">
          <p className="text-[9px] text-white/18 tracking-[0.22em] uppercase px-1 pb-1.5">
            Switch Mode
          </p>
          ...
          {allModes.map((m, i) => {
            ...
            return (
              <motion.button
                ...
                style={{
                  background: isActive ? m.bg : "rgba(255,255,255,0.0)",
        ...
        <div className="shrink-0 px-4 py-3 border-t border-white/[0.05]">
          <p className="text-[9px] text-white/16 text-center leading-relaxed">
            Each mode keeps its own history
          </p>
        </div>
      </motion.aside>
    </>
